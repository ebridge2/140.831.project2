---
title: "Vector Magnitude Count Exploratory Analysis"
author: "Jiyang, Eric"
date: "2019/10/8"
...
data=readRDS("../../data/acc_data.rds")
user_list=names(data)
```
# A function to summarise vector magnitude count for all partcipants for different device locations and different time windows.   
...
```
# Time window
```{r, echo=FALSE,out.width="33%", out.height="20%",fig.cap="caption",fig.cap="Figure 1: Ascending stairs plots on left ankle for different time windows",fig.show='hold',fig.align='center'}
knitr::include_graphics(c("left_ankle _ ascending_stairs _ 3 .png","left_ankle _ ascending_stairs _ 5 .png","left_ankle _ ascending_stairs _ 10 .png"),)
``` 

# Activity type
```{r, echo=FALSE,out.width="33%", out.height="20%",fig.cap="caption",fig.cap="Figure 2: VMC on left ankle device for 3s time window on different activity types",fig.show='hold',fig.align='center'}
knitr::include_graphics(c("left_ankle _ clapping _ 3 .png","left_ankle _ walking _ 3 .png","left_ankle _ driving _ 3 .png"),)
``` 
```{r, echo=FALSE,out.width="50%", out.height="20%",fig.cap="caption",fig.cap="Figure 2 (cont'): VMC on left ankle device for 3s time window on different activity types",fig.show='hold',fig.align='center'}
knitr::include_graphics(c("left_ankle _ ascending_stairs _ 3 .png","left_ankle _ descending_stairs _ 3 .png"),)
``` 
We found that clapping, driving and walking have their own distinct features, but it is difficult to distinguish from ascending stairs from descending stairs. Therefore we need more features.